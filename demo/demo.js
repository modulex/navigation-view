...
require('util,' +
        ...
        'promise,' +
        window.PAGE_VIEW,
    function (util,NavigationView, Bar, Node,TapGesture, BasicGesture,router, Promise, pageViewFactory) {
        ...
        PageView.extend({
            enter: function (cfg) {
                console.log('enter loading ' + (cfg.fromCache ? 'from cache!' : ''));
                var self = this;
                ...
                if (self.logic) {
                    ...
                    require(['demo/loading'], function (Loading) {
                        /*jshint nonew:false*/
